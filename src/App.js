    ...
    <h1 className="name">{name}</h1>
     ...
     <div  className="movieCon ">
      ...
      <a
        ...
        >  <img src={poster} className="contentImg" alt={name} title={name} /> </a> <p> <a href={`https:youtu.be/${trailer.split("/")[trailer.split("/").length-1]}`} className="App-link"> Watch Trailer  </a></p>
     ...
     <iframe  src={`${trailer}?controls=1&autoplay=1&mute=1`} title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen className="video"></iframe> </div>
